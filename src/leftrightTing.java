...
public class leftrightTing extends MazeElement {
    private int direction; 
    private BufferedImage image;


    public leftrightTing(Location location, BufferedImage image) {
    ...
    public void move(char[][] maze) {
        ...
        Location nextLocation = new Location(currentRow, currentCol + direction);
